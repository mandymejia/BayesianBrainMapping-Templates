...
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "15IC", "GSR=T", "template_combined_15ICs_GSRT_IC1_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "15IC", "GSR=T", "template_combined_15ICs_GSRT_IC15_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "15IC", "GSR=T", "template_combined_15ICs_GSRT_IC1_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "15IC", "GSR=T", "template_combined_15ICs_GSRT_IC15_sd.png"))
```
...
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "25IC", "GSR=T", "template_combined_25ICs_GSRT_IC1_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "25IC", "GSR=T", "template_combined_25ICs_GSRT_IC25_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "25IC", "GSR=T", "template_combined_25ICs_GSRT_IC1_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "25IC", "GSR=T", "template_combined_25ICs_GSRT_IC25_sd.png"))
```
...
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "50IC", "GSR=T", "template_combined_50ICs_GSRT_IC1_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "50IC", "GSR=T", "template_combined_50ICs_GSRT_IC50_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "50IC", "GSR=T", "template_combined_50ICs_GSRT_IC1_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "50IC", "GSR=T", "template_combined_50ICs_GSRT_IC50_sd.png"))
```
...
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "Yeo17", "GSR=T", "template_combined_yeo17_GSRT_DefaultA_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "Yeo17", "GSR=T", "template_combined_yeo17_GSRT_DorsAttnA_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "Yeo17", "GSR=T", "template_combined_yeo17_GSRT_DefaultA_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "Yeo17", "GSR=T", "template_combined_yeo17_GSRT_DorsAttnA_sd.png"))
```
...
```{r fig.show='hold', out.width='48%'}
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_15ICs_GSRT_FC_Cholesky_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_15ICs_GSRT_FC_InverseWishart_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_15ICs_GSRT_FC_Cholesky_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_15ICs_GSRT_FC_InverseWishart_sd.png"))
```

#### 6.4.2 25 ICs

```{r fig.show='hold', out.width='48%'}
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_25ICs_GSRT_FC_Cholesky_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_25ICs_GSRT_FC_InverseWishart_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_25ICs_GSRT_FC_Cholesky_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_25ICs_GSRT_FC_InverseWishart_sd.png"))
```

#### 6.4.3 50 ICs

```{r fig.show='hold', out.width='48%'}
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_50ICs_GSRT_FC_Cholesky_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_50ICs_GSRT_FC_InverseWishart_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_50ICs_GSRT_FC_Cholesky_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_50ICs_GSRT_FC_InverseWishart_sd.png"))
```

#### 6.4.4 Yeo17

```{r fig.show='hold', out.width='48%'}
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_yeo17_GSRT_FC_Cholesky_mean.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_yeo17_GSRT_FC_InverseWishart_mean.png"))

knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_yeo17_GSRT_FC_Cholesky_sd.png"))
knitr::include_graphics(file.path(dir_data, "priors_plots", "combined", "FC", "template_combined_yeo17_GSRT_FC_InverseWishart_sd.png"))
```

## 7. Individual Analysis Example

example on how to use the priors TEMAPLATE ICA VISUALIZATION
- lets pick one - 15 ic, gsr true, combined list
- engagements
- BrainMap
